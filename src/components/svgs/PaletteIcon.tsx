...
export default function PaletteIcon({ className = "", size = 48 }: PaletteIconProps) {
  const swatches = [
    ...
    { cx: 34, cy: 15, fill: "#E2542A" },
    { cx: 42, cy: 24, fill: "#2C7466" },
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="white"
        stroke="rgba(25,26,23,0.15)"
        strokeWidth="1.5"
      />
      {/* Thumb hole */}
      <ellipse cx="22" cy="38" rx="5" ry="6" fill="rgba(25,26,23,0.08)" stroke="rgba(25,26,23,0.12)" strokeWidth="1" />
      {/* Swatches */}
      {swatches.map((s, i) => (
